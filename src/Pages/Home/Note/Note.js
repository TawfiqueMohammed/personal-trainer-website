    ...
    return (
        <div id='note' style={{ border: '1px solid grey' }} className='container mt-5 p-5'>
            ...
            <h5 className='fw-light pt-2'>I am so happy you are here and I am thrilled to share this online learning platform with you!
                ...
                <br />
                <div>
                    I can’t wait to hear about the powerful impact they have on your life! Take a look around, sign up for the course that resonates with you in your current life chapter, and join our community!
                </div>
                <br />
                Much love,
